...
def main(region, parameters, problem, data):
    ...
    variable_to_export = [Flow.pressure, Flow.P0_flux, Flow.permeability, \
                          Flow.P0_flux_norm, Flow.region]
...
if __name__ == "__main__":
    ...
    data = Data(parameters, problem) # get data for computation of speed-dependent permeability
    ...
    if compute_errors:
        print(" ", "---- Compute errors with respect to the Forchheimer scheme ----", sep="\n")
